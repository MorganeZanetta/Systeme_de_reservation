...
<body>
    ...
    <div class="interface_utilisateur">
        ...
        <div id="formulaire">
            <form id="formulaire_reservation" action="index.php?action=creerReservationAdmin" method="POST">
                ...
                <fieldset>
                    ...
                    <section id="formulaire_colonne">
                        ...
                        <div class="formulaire_input">
                            <button name="bouton_administrateur" class="bouton_administrateur" type="submit" style="width: 100%;">Valider la réservation</button>
                        </div>
                    </section>
                </fieldset>
            </form>
