...
<body>
    ...
    <div class="interface_utilisateur">
       <div id="calendrier">
        ...
        <div id="formulaire">
            <form id="formulaire_reservation" action="index.php?action=modifierReservationAdmin" method="POST">
                <input type="hidden" id="id_reservation_en_cours" value="<?= htmlspecialchars($reservation->getIdRes()); ?>">
                <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($_SESSION['csrf_token'] ?? '') ?>">
                <input type="hidden" name="id" value="<?= htmlspecialchars($reservation->getIdRes()); ?>">
                
                <fieldset>
    <legend>Modifier la réservation (Accès Administrateur)</legend>
    <section id="formulaire_colonne">
        <div class="formulaire_input">
            ...
            <input type="text" name="motif_reservation" id="motif_reservation" 
        ...
        <div class="formulaire_input">
            <div id="bouton_administrateur_modification">
                <a name="bouton_modification_admin" class="bouton_modification_admin" href="index.php?action=interfaceListeReservationAdministrateur" >Revenir à la liste des réservations</a>
                <button name="bouton_modification_admin" class="bouton_modification_admin" type="submit">Modifier la réservation</button>
                            </div>
                        </div>
                </section>
            </fieldset>
