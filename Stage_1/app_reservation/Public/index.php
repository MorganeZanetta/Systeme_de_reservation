...
switch ($action) {
    ...
    break;
        ...
        // --- Actions CRUD Utilisateurs (Admin) ---
    case 'creerUtilisateursAdmin':
    case 'modifierUtilisateursAdmin':
    case 'supprimerUtilisateursAdmin':
        $controller = new AdminController($pdo);
        $controller->$action(); // Appel dynamique des méthodes : creerUtilisateursAdmin(), etc.
        break;
